  ...
  <fieldset style="display: inline-block;">
    <div class="container">
      ...
      <div class="form-horizontal">
        ...
        <div class="form-group">
          <label class="control-label col-xs-3">DirecciÃ³n:</label>

          <div class="col-xs-9">
            <textarea rows="3" class="form-control" placeholder="DirecciÃ³n" id="direccion"></textarea>
          </div>
          <div class="form-group">
